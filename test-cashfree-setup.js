...
async function testCashfreeSetup() {
  ...
  try {
    ...
    try {
      ...
      if (cashfreeResponse.data.isMock) {
        console.log('⚠️  Using mock payments (no real credentials)');
        console.log('   Set CASHFREE_APP_ID and CASHFREE_SECRET_KEY for real payments');
      } else {
    ...
    try {
      ...
      if (paymentResponse.data.isMock) {
        console.log('🎭 Mock payment mode (no real credentials)');
        console.log('   To use real payments, set CASHFREE_APP_ID and CASHFREE_SECRET_KEY');
      } else {
    ...
    if (process.env.CASHFREE_APP_ID && process.env.CASHFREE_SECRET_KEY) {
      ...
      console.log('- Cashfree: ⚠️  Using mock payments (set credentials for real payments)');
    }
